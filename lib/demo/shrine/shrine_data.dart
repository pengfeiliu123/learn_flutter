...
const Vendor _ali = const Vendor(
    name: 'Ali’s shop',
    avatarAsset: 'assets/images/shrine/vendors/ali-connors.png',
    description:
...
const Vendor _sandra = const Vendor(
    name: 'Sandra’s shop',
    avatarAsset: 'assets/images/shrine/vendors/sandra-adams.jpg',
    description:
...
const Vendor _trevor = const Vendor(
    name: 'Trevor’s shop',
    avatarAsset: 'assets/images/shrine/vendors/zach.jpg',
    description:
...
const Vendor _peter = const Vendor(
    name: 'Peter’s shop',
    avatarAsset: 'assets/images/shrine/vendors/peter-carlsson.png',
    description:
...
const Vendor _stella = const Vendor(
    name: 'Stella’s shop',
    avatarAsset: 'assets/images/shrine/vendors/16c477b.jpg',
    description:
...
const List<Product> _allProducts = const <Product>[
  const Product(
      ...
      imageAsset: 'assets/images/shrine/products/radio.png',
  ...
  const Product(
      name: 'Sunglasses',
      imageAsset: 'assets/images/shrine/products/sunnies.png',
  ...
  const Product(
      name: 'Clock',
      imageAsset: 'assets/images/shrine/products/clock.png',
  ...
  const Product(
      name: 'Red popsicle',
      imageAsset: 'assets/images/shrine/products/popsicle.png',
  ...
  const Product(
      name: 'Folding Chair',
      imageAsset: 'assets/images/shrine/products/lawn_chair.png',
      categories: const <String>['furniture'],
      price: 63.00,
      vendor: _stella,
      description:
  ...
  const Product(
      ...
      imageAsset: 'assets/images/shrine/products/chair.png',
      categories: const <String>['furniture'],
      price: 36.00,
      vendor: _ali,
      description:
  ...
  const Product(
      ...
      imageAsset: 'assets/images/shrine/products/heels.png',
  ...
  const Product(
      name: 'Green Slip-ons',
      imageAsset: 'assets/images/shrine/products/green-shoes.png',
  ...
  const Product(
      name: 'Teapot',
      imageAsset: 'assets/images/shrine/products/teapot.png',
  ...
  const Product(
      ...
      imageAsset: 'assets/images/shrine/products/chucks.png',
      categories: const <String>['travel', 'fashion'],
      price: 89.00,
      vendor: _trevor,
      description:
  ...
  const Product(
      name: 'Dipped Brush',
      imageAsset: 'assets/images/shrine/products/brush.png',
  ...
  const Product(
      ...
      imageAsset: 'assets/images/shrine/products/fish_bowl.png',
  ...
  const Product(
      ...
      imageAsset: 'assets/images/shrine/products/lipstick.png',
      categories: const <String>['fashion', 'beauty'],
      price: 54.00,
      vendor: _sandra,
      description:
  ...
  const Product(
      name: 'Backpack',
      imageAsset: 'assets/images/shrine/products/backpack.png',
      categories: const <String>['travel', 'fashion'],
      price: 25.00,
      vendor: _peter,
      description:
  ...
  const Product(
      ...
      imageAsset: 'assets/images/shrine/products/helmet.png',
  ...
  const Product(
      name: 'Beachball',
      imageAsset: 'assets/images/shrine/products/beachball.png',
  ...
  const Product(
      name: 'Old Binoculars',
      imageAsset: 'assets/images/shrine/products/binoculars.png',
      categories: const <String>['travel', 'fashion', 'latest'],
      price: 25.00,
      vendor: _stella,
      description:
  ...
  const Product(
      name: 'Lime Flippers',
      imageAsset: 'assets/images/shrine/products/flippers.png',
      categories: const <String>['travel', 'fashion', 'beauty'],
      price: 25.00,
      vendor: _peter,
      description:
  ...
  const Product(
      name: 'Surfboard',
      imageAsset: 'assets/images/shrine/products/surfboard.png',
